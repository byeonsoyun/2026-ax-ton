...
import { EQUIPMENT_ID } from "@/lib/seed/press-machine";
import { completeTrainingRecord, getTrainingRecord } from "@/lib/storage";
...
export default function CompletePage({
  ...
  const [saved, setSaved] = useState<TrainingRecord | null>(() => getTrainingRecord(recordId));
  ...
  function handleSign() {
    ...
    const record = completeTrainingRecord(recordId, results, signature.trim());
    setSaved(record);
  }
    ...
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-6 p-6 text-center">
        ...
        <div className="flex flex-col gap-3">
          <DownloadCertificateButton record={saved} equipmentName="프레스기 1호" />
          <a
